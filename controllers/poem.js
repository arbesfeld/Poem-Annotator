var parse = require("../js/parser").parse;
var searchPoem = require("../js/poem-search").searchPoem;
...
module.exports = function (app) {
  ...
  app.post('/poem', function(req, res, next) {
